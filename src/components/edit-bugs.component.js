...
export default class EditBug extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:4000/bugs/update/'+ this.props.match.params.id, bug)
        ...
        return (
            <div>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group pt-3">
                    <input type="submit" value="Update bug log" className="btn btn-primary" />
                    </div>
                </form>
            </div>
        )
